...
| 3 | the metric from the weights, end to end | `download.py --tier pools` (36.7 GiB) and, for the method pool, `download_external.py` | 20/23 are other groups' releases |
...
**Score the released checkpoints from pixels** (0.9–37 GiB of checkpoints + one base dataset):
